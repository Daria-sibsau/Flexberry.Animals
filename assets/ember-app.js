...
define('ember-app/mixins/regenerated/models/i-i-s-animals-animal', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var Model = exports.Model = Ember.Mixin.create({
    ...
    burrow: _emberData.default.hasMany('i-i-s-animals-burrow', { inverse: 'animal', async: false })
  });
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('AnimalE', 'i-i-s-animals-animal', {
      ...
      burrow: (0, _attributes.hasMany)('i-i-s-animals-burrow', 'Burrow', {
        name: (0, _attributes.attr)('Name', { index: 0 }),
...
define('ember-app/mixins/regenerated/models/i-i-s-animals-burrow', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var Model = exports.Model = Ember.Mixin.create({
    ...
    animal: _emberData.default.belongsTo('i-i-s-animals-animal', { inverse: 'burrow', async: false })
  });
  ...
  exports.default = _offlineGlobals.default.extend({
    ...
    getOfflineSchema: function getOfflineSchema() {
      ...
      var returnedSchema = Ember.merge(parentSchema, {
        'i-i-s-animals-animal': 'id,name,*burrow',
