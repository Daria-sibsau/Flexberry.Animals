...
namespace IIS.Animals
{
    ...
    public class Animal : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Animals.DetailArrayOfBurrow fBurrow;
        ...
        public virtual IIS.Animals.DetailArrayOfBurrow Burrow
        {
            get
            {
                ...
                {
                    this.fBurrow = new IIS.Animals.DetailArrayOfBurrow(this);
                }
                IIS.Animals.DetailArrayOfBurrow result = this.fBurrow;
